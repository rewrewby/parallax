...
func NewPrivateAdminAPI(eth *Parallax) *PrivateAdminAPI {
...
func NewPublicDebugAPI(eth *Parallax) *PublicDebugAPI {
...
func NewPrivateDebugAPI(eth *Parallax) *PrivateDebugAPI {
