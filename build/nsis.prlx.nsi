...
# 1. install prlx for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for prlx
# 5. create prlx, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable PARALLAX_SOCKET
...
!define GROUPNAME "Parallax"
!define APPNAME "Prlx"
!define DESCRIPTION "Official Go implementation of the Parallax protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since prlx is installed global
