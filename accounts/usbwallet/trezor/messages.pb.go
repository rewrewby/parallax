...
const (
	...
	// Ethereum
	MessageType_MessageType_ParallaxGetPublicKey     MessageType = 450
	MessageType_MessageType_ParallaxPublicKey        MessageType = 451
	MessageType_MessageType_ParallaxGetAddress       MessageType = 56
	MessageType_MessageType_ParallaxAddress          MessageType = 57
	MessageType_MessageType_ParallaxSignTx           MessageType = 58
	MessageType_MessageType_ParallaxTxRequest        MessageType = 59
	MessageType_MessageType_ParallaxTxAck            MessageType = 60
	MessageType_MessageType_ParallaxSignMessage      MessageType = 64
	MessageType_MessageType_ParallaxVerifyMessage    MessageType = 65
	MessageType_MessageType_ParallaxMessageSignature MessageType = 66
	// NEM
