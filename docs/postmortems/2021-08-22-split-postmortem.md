...
This is a post-mortem concerning the minority split that occurred on Parallax mainnet on block [13107518](https://etherscan.io/block/13107518), at which a minority chain split occurred.
...
> The primary goal for the Geth team is the health of the Parallax network as a whole, and the decision whether or not to publish details about a serious vulnerability boils down to minimizing the risk and/or impact of discovery and exploitation.
